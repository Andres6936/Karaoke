...
export default function Soundwave({size}: Props){
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size ?? 16} height={size ?? 16} fill="currentColor" className="bi bi-soundwave" viewBox="0 0 16 16">
