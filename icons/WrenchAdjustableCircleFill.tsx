...
export default function WrenchAdjustableCircleFill({size}: Props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={size ?? 16} height={size ?? 16} fill="currentColor" className="bi bi-wrench-adjustable-circle-fill" viewBox="0 0 16 16">
